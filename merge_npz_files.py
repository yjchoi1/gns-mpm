...
default_connectivity_radius = 0.15
dim = int(3)
dt_mpm = 0.0025  # 0.0025
mpm_cell_size = [0.1, 0.1, 0.1]  # [0.0125, 0.0125]
nparticles_per_cell = 4*4*4  # int(16)
dt_gns = 1.0  # 1.0 is default

mpm_dir = "./mpm"  # "./mpm"
data_case = "3dsand_train"  # "mpm-9k-train"
# data_tags = [str(i) for i in np.arange(0, 24)] + [str(25), str(26)]
data_tags = range(0, 60)
save_name = "3dsand_train_merged"
