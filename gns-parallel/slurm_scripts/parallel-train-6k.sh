...
#SBATCH -J pyt_sand-6k-r019-parallel         # Job name
#SBATCH -o pyt_sand-6k-r019-parallel.o%j     # Name of stdout output file
#SBATCH -e pyt_sand-6k-r019-parallel.e%j     # Name of stderr error file
...
export DATASET_NAME="sand-6k_parallel"
