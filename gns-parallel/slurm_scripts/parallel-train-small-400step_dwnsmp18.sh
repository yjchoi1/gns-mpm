...
#SBATCH -J pyt_sand-small-ds-18         # Job name
#SBATCH -o pyt_sand-small-ds-18.o%j     # Name of stdout output file
#SBATCH -e pyt_sand-small-ds-18.e%j     # Name of stderr error file
...
export DATASET_NAME="sand-small-r300_parallel_dwnsmp18"
