...
#SBATCH -J pyt_mpm_train-small3-r300         # Job name
#SBATCH -o pyt_mpm_train-small3-r300.o%j     # Name of stdout output file
#SBATCH -e pyt_mpm_train-small3-r300.e%j     # Name of stderr error file
