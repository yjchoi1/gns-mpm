...
#SBATCH -J pyt_droplet2         # Job name
#SBATCH -o pyt_droplet2.o%j     # Name of stdout output file
#SBATCH -e pyt_droplet2.e%j     # Name of stderr error file
