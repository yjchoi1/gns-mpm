#!/bin/bash
#SBATCH -J pyt_train_r049         # Job name
#SBATCH -o pyt_train_r049.o%j     # Name of stdout output file
#SBATCH -e pyt_train_r049.e%j     # Name of stderr error file
...
export DATASET_NAME="sand-2d-r049"
