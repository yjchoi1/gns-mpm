...
#SBATCH -J pyt_sand-small-r300-parallel         # Job name
#SBATCH -o pyt_sand-small-r300-parallel.o%j     # Name of stdout output file
#SBATCH -e pyt_sand-small-r300-parallel.e%j     # Name of stderr error file
...
# directories
export DATASET_NAME="sand-small-r300-400step_parallel"
