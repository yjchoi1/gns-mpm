...
#SBATCH -J pyt_sand-small-r190         # Job name
#SBATCH -o pyt_sand-small-r190.o%j     # Name of stdout output file
#SBATCH -e pyt_sand-small-r190.e%j     # Name of stderr error file
...
# directories
export DATASET_NAME="sand-2d-small-r190"
