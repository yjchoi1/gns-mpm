...
#SBATCH -A ECS22003
#SBATCH -J pyt_sand2d-r055         # Job name
#SBATCH -o pyt_sand2d-r055.o%j     # Name of stdout output file
#SBATCH -e pyt_sand2d-r055.e%j     # Name of stderr error file
...
# directories
export DATASET_NAME="sand-2d-r055"
