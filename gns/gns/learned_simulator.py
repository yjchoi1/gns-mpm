...
class LearnedSimulator(nn.Module):
  ...
  def _encoder_preprocessor(
    ...
    normalized_clipped_distance_to_boundaries = torch.clamp(
        distance_to_boundaries / (self._connectivity_radius), -self._boundary_augment, self._boundary_augment)
    ...
    # 30 = 10 (5 velocity sequences*dim) + 4 boundaries + 16 particle embedding + 1 material property
