...
flags.DEFINE_string('model_file', 'model-15000000.pt', help=('Model filename (.pt) to resume from. Can also use "latest" to default to newest file.'))
flags.DEFINE_string('train_state_file', "train_state-1500000.pt", help=('Train state filename (.pt) to resume from. Can also use "latest" to default to newest file.'))
flags.DEFINE_string('rollout_filename', "rollout_test0-3", help='Name saving the rollout')
