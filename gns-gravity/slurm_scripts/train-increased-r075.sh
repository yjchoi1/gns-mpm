...
#SBATCH -A ECS22003
#SBATCH -J pyt_sand2d-inc-r075         # Job name
#SBATCH -o pyt_sand2d-inc-r075.o%j     # Name of stdout output file
#SBATCH -e pyt_sand2d-inc-r075.e%j     # Name of stderr error file
...
export DATASET_NAME="sand-2d-increased-r075"
